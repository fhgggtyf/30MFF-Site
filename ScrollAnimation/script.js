...
function scrollEvent() {
	...
	if (sectionNum == 0) {
		...
		document.getElementById('door').style.backgroundAttachment = "scroll";
		document.getElementById('room').style.backgroundAttachment = "scroll";
		document.getElementById('floor').style.backgroundAttachment = "scroll";
	}
	else if (sectionNum == 1) {
		document.getElementById('outside').style.backgroundAttachment = "scroll";
		document.getElementById('door').style.backgroundAttachment = "fixed";
		document.getElementById('room').style.backgroundAttachment = "scroll";
		document.getElementById('floor').style.backgroundAttachment = "scroll";
	}
		...
		document.getElementById('door').style.backgroundAttachment = "scroll";
		document.getElementById('room').style.backgroundAttachment = "scroll";
		document.getElementById('floor').style.backgroundAttachment = "fixed";
	}
